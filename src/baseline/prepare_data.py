...
def prepare_data() -> None:
    ...
    featured_df = create_features(merged_df, book_genres_df, descriptions_df, include_aggregates=False, include_bert=False, include_nomic=True, use_nomic_compression=False)
